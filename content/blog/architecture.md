...
This post covers how the **SSG Engine** operates under the hood. I decided to use this project as a way to learn the Odin language, as well as make something unique for my own cv and thoughts. 
