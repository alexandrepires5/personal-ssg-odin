...
### Integrated Master's in Electrical Engineering and Computing
**Faculdade de Engenharia da Universidade do Porto**
**09/2011 – 03/2016 | Porto, Portugal**
- **Thesis/Projects:** Modelling and Path Planning of a Hyper Redundant Manipulator; Development of a 3D Lidar System for static mapping.

### Udacity Robotics Software Engineer Nanodegree
**Udacity**
**08/2017 – 01/2018**
- Implemented basic algorithms for control and decision-making of a robot in an unknown environment.
- Developed a 3D Perception Pipeline utilizing SVMs for Pick & Place operations.
- Trained and implemented deep neural networks for target following using a quadcopter.
...
## Interests
Sports, Medicine, Cinema, Reading, Continuous Learning, Gym, Travelling, Programming, Innovation
